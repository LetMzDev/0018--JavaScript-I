...
const resultado_2 = logado && admin;

console.log ( 'Administrador logado no sistema:', resultado_2 );
...
const resultado_3 = condicao1 || condicao2;

console.log ( 'Resultado do operador OR:', resultado_3 ); // Saída: true
